 ...
 * The second constructor has parameter width and height of type double & it needs to initialise the fields.
 * In case the width is less than 0, it needs to set the width field value to 0,
 * in case the height parameter is less than 0, it needs to set the height field value to 0.
 * Write the following methods (instance methods) :
 * * Method named getWidth without any parameters, it needs to return the value of width field.
 * * Method names getHeight without any parameters, it needs to return the value of height field.
